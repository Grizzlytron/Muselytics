# PersonalAnalytics (Musified) - Privacy-protecting, open-source Self-Monitoring Software

---

PersonalAnalytics (Musified) is Lucas\' extension of PersonalAnalytics, which integrates a Muse S Athena (2025) tracker into PersonalAnalytics and extends the self-monitoring software developed by the Human Aspects of Software Engineering Lab of the University of Zurich to non-intrusively collect computer interaction data and store it locally on your computer. This extension includes the possibility to collect biometric data recorded by the Muse S from [InteraXon Inc](choosemuse.com). Every now and then, a self-reflection question asks you about time well spent and perceived productivity. This software is open source, can be adapted and re-used for your own scientific studies.
